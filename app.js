...
app.post("/submit", (req, res) => {
    ...
    doc.addImage(base64_encode("./cpulogo.png"), "PNG", 10, 30, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(req.body.c1, 25, 37)
    doc.addImage(base64_encode("./ramlogo.png"), "PNG", 10, 45, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(`RAM: ${req.body.r1}`, 25, 52)
    doc.addImage(base64_encode("./storagelogo.png"), "PNG", 10, 60, 10, 10)
    if (req.body.q1a === "on") {
    ...
    if (req.body.officeQ1 === "yes") {
        ...
        doc.addImage(base64_encode("./wrlogo.png"), "PNG", 10, 107, 10, 10)
    ...
    doc.setTextColor(0, 0, 0);
    doc.addImage(base64_encode("./cpulogo.png"), "PNG", 115, 30, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(req.body.c2, 130, 37)
    doc.addImage(base64_encode("./ramlogo.png"), "PNG", 115, 45, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(`RAM: ${req.body.r2}`, 130, 52)
    doc.addImage(base64_encode("./storagelogo.png"), "PNG", 115, 60, 10, 10)
    if (req.body.q2a === "on") {
    ...
    if (req.body.officeQ2 === "yes") {
        ...
        doc.addImage(base64_encode("./wrlogo.png"), "PNG", 115, 107, 10, 10)
    ...
    doc.setTextColor(0, 0, 0);
    doc.addImage(base64_encode("./cpulogo.png"), "PNG", 10, 175, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(req.body.c3, 25, 182)
    doc.addImage(base64_encode("./ramlogo.png"), "PNG", 10, 190, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(`RAM: ${req.body.r3}`, 25, 197)
    doc.addImage(base64_encode("./storagelogo.png"), "PNG", 10, 205, 10, 10)
    if (req.body.q3a === "on") {
    ...
    if (req.body.officeQ3 === "yes") {
        ...
        doc.addImage(base64_encode("./wrlogo.png"), "PNG", 10, 252, 10, 10)
    ...
    doc.setTextColor(0, 0, 0);
    doc.addImage(base64_encode("./cpulogo.png"), "PNG", 115, 175, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(req.body.c4, 130, 182)
    doc.addImage(base64_encode("./ramlogo.png"), "PNG", 115, 190, 10, 10)
    doc.setFont(undefined, "normal").setFontSize(12).text(`RAM: ${req.body.r4}`, 130, 197)
    doc.addImage(base64_encode("./storagelogo.png"), "PNG", 115, 205, 10, 10)
    if (req.body.q4a === "on") {
    ...
    if (req.body.officeQ4 === "yes") {
        ...
        doc.addImage(base64_encode("./wrlogo.png"), "PNG", 115, 252, 10, 10)
