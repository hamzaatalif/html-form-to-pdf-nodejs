...
app.post("/submit", (req, res) => {
    ...
    if (req.body.nr1n === "on") {
        ...
        doc.circle(90, 130, 10);
        doc.setTextColor(204, 0, 0);
        doc.setFont(undefined, "bold").setFontSize(10).text("REFURB", 83, 131.5)
    }
    ...
    if (req.body.nr2n === "on") {
        ...
        doc.circle(197, 130, 10);
        doc.setTextColor(204, 0, 0);
        doc.setFont(undefined, "bold").setFontSize(10).text("REFURB", 190, 131.5)
    }
    ...
    if (req.body.nr3n === "on") {
        ...
        doc.circle(90, 275, 10);
        doc.setTextColor(204, 0, 0);
        doc.setFont(undefined, "bold").setFontSize(10).text("REFURB", 83, 276.5)
    }
    ...
    if (req.body.nr4n === "on") {
        ...
        doc.circle(197, 275, 10);
        doc.setTextColor(204, 0, 0);
        doc.setFont(undefined, "bold").setFontSize(10).text("REFURB", 190, 276.5)
    }
